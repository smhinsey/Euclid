...
#line hidden
		...
		public virtual void FeatureSetup()
		{
			...
			var featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Euclid agents provide metadata about their parts",
			                                                    "In order to satisfy requests for metadata\r\nAs an agent\r\nI need to provide metadat" +
			                                                    "a in arbitrary formats", ProgrammingLanguage.CSharp, ((string[]) (null)));
		...
		{
			var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Supported Agent metadata formats", exampleTags);
#line 7
