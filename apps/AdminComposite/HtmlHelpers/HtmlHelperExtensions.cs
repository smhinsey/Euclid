...
namespace AdminComposite.HtmlHelpers
{
	public static class HtmlHelperExtensions
	{
		public static string GetClassWhenControllerIsCurrent(this HtmlHelper helper, string expectedController, string className)
		{
			return GetClassWhenControllerAndActionAreCurrent(helper, expectedController, null, className);
		}

		public static string GetClassWhenControllerAndActionAreCurrent(this HtmlHelper helper, bool additional, string expectedController, string expectedAction, string className)
		{
		...
		public static string GetClassWhenControllerAndActionAreCurrent(this HtmlHelper helper, string expectedController, string expectedAction, string className)
		{
			return helper.GetClassWhenControllerAndActionAreCurrent(true, expectedController, expectedAction, className);
		}

		public static bool AreControllerAndActionAreCurrent(this HtmlHelper helper, string expectedController, string expectedAction)
		{
			...
			return (
			       	(expectedAction == null && expectedController.Equals(controller, StringComparison.OrdinalIgnoreCase))
			       	||
