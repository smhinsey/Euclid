...
#line hidden
			...
			table1.AddRow(
				new string[]
					{
						"Vote up post", "Post Body", "11111111-1111-1111-1111-111111111111", "00000000-0000-0000-0000-000000000000",
...
#line hidden
			var table2 = new TechTalk.SpecFlow.Table(new string[] { "AuthorIdentifier", "VoteUp" });
			table2.AddRow(new string[] { "00000000-0000-0000-0000-000000000000", "true" });
#line 15
...
#line hidden
			...
			table3.AddRow(
				new string[]
					{
						"Vote Post Down", "Post Body", "11111111-1111-1111-1111-111111111111", "00000000-0000-0000-0000-000000000000",
						"22222222-2222-2222-2222-222222222222"
					});
#line 25
...
#line 28
			testRunner.And("the command is complete");
#line hidden
			var table4 = new TechTalk.SpecFlow.Table(new string[] { "AuthorIdentifier", "VoteUp" });
			table4.AddRow(new string[] { "00000000-0000-0000-0000-000000000000", "false" });
#line 30
...
#line 43
			testRunner.And("the command is complete");
#line hidden
			var table6 = new TechTalk.SpecFlow.Table(new string[] { "Title", "Body", "AuthorIdentifier", "ForumIdentifier" });
			table6.AddRow(
				new string[]
...
#line 48
			testRunner.And("the command is complete");
#line hidden
			var table7 = new TechTalk.SpecFlow.Table(new string[] { "AuthorIdentifier", "VoteUp" });
			table7.AddRow(new string[] { "00000000-0000-0000-0000-000000000000", "true" });
#line 50
...
#line 63
			testRunner.And("the command is complete");
#line hidden
			var table9 = new TechTalk.SpecFlow.Table(new string[] { "Title", "Body", "AuthorIdentifier", "ForumIdentifier" });
			table9.AddRow(
				new string[]
...
#line 68
			testRunner.And("the command is complete");
#line hidden
			var table10 = new TechTalk.SpecFlow.Table(new string[] { "AuthorIdentifier", "VoteUp" });
			table10.AddRow(new string[] { "00000000-0000-0000-0000-000000000000", "false" });
#line 70
