...
#line hidden
			var table1 =
				new TechTalk.SpecFlow.Table(new string[] { "Username", "PasswordHash", "PasswordSalt", "ForumIdentifier" });
			table1.AddRow(new string[] { "johndoe", "hash", "salt", "22222222-2222-2222-2222-222222222222" });
#line 10
			testRunner.When("I publish the command RegisterUser:", ((string)(null)), table1);
#line 13
			testRunner.And("the command is complete");
#line hidden
			var table2 = new TechTalk.SpecFlow.Table(new string[] { "Username" });
			table2.AddRow(new string[] { "johndoe" });
#line 15
			testRunner.Then("run FindByUsername on UserQueries with:", ((string)(null)), table2);
#line hidden
			var table3 =
				new TechTalk.SpecFlow.Table(new string[] { "Username", "PasswordHash", "PasswordSalt", "ForumIdentifier" });
			table3.AddRow(new string[] { "johndoe", "hash", "salt", "22222222-2222-2222-2222-222222222222" });
#line 19
...
#line hidden
			var table4 =
				new TechTalk.SpecFlow.Table(new string[] { "Username", "PasswordHash", "PasswordSalt", "ForumIdentifier" });
			table4.AddRow(new string[] { "johndoe", "hash", "salt", "22222222-2222-2222-2222-222222222222" });
#line 27
			testRunner.When("I publish the command RegisterUser:", ((string)(null)), table4);
#line 30
			testRunner.And("the command is complete");
#line hidden
			var table5 = new TechTalk.SpecFlow.Table(new string[] { "Email", "AvatarUrl" });
			table5.AddRow(new string[] { "johndoe@doejohn.com", "http://avatar/johndoe" });
#line 32
			testRunner.When("I publish the command UpdateUserProfile:", ((string)(null)), table5);
#line 35
			testRunner.And("the command is complete");
#line hidden
			var table6 = new TechTalk.SpecFlow.Table(new string[] { "Username" });
			table6.AddRow(new string[] { "johndoe" });
#line 37
			testRunner.Then("run UserProfileByUsername on UserQueries with:", ((string)(null)), table6);
#line hidden
			var table7 = new TechTalk.SpecFlow.Table(new string[] { "Email", "AvatarUrl" });
			table7.AddRow(new string[] { "johndoe@doejohn.com", "http://avatar/johndoe" });
#line 41
...
#line hidden
			var table8 =
				new TechTalk.SpecFlow.Table(new string[] { "Username", "PasswordHash", "PasswordSalt", "ForumIdentifier" });
			table8.AddRow(new string[] { "johndoe", "hash", "hash", "22222222-2222-2222-2222-222222222222" });
#line 48
