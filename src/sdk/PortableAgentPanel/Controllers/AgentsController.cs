...
namespace CompositeInspector.Controllers
{
    ...
    public class AgentsController : Controller
    {
        ...
        [FormatInputModel]
        public ActionResult ViewInputModelForCommand(IInputModel inputModel, IAgentPartMetadata typeMetadata,
                                                     string format)
        {
                    ...
                    new PartModel
                        {
                            ...
                            NextActionName =
                                (containingCollection.DescriptiveName == "Commands")
                                    ? "ViewInputModelForCommand"
                                    : "ViewPart",
                    ...
                    new PartCollectionModel
                        {
                            ...
                            NextActionName =
                                (partCollection.DescriptiveName == "Commands") ? "ViewInputModelForCommand" : "ViewPart",
                            AgentSytemName = partCollection.AgentSystemName,
                            PartDescriptiveName = partCollection.DescriptiveName
                        });
        }
