...
namespace CompositeControl.Areas.CompositeControl.Views.Shared
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/CompositeControl/Views/Shared/MetadataLinks.cshtml")]
    public class _Page_Areas_CompositeControl_Views_Shared_MetadataLinks_cshtml : System.Web.Mvc.WebViewPage<FooterLinkModel>
    {
#line hidden

        public _Page_Areas_CompositeControl_Views_Shared_MetadataLinks_cshtml()
        {
        }
...
WriteLiteral("\t\t<li class=\"metadata-link-item\"><a class=\"metadata-link\" href=\"");
                                                           ...
                                                           Write(Url.Action("Index", "Composite"));

WriteLiteral("\">\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t \tComposite details</a></li>\r\n\t</ul>\r\n</div>");
