...
; (function ($) {
	var app = $.sammy(function () {
		...
		this.get('/composite/new/#composite-explorer', function () {
			...
			WorkWithDataFromUrl("/composite/api", function (compositeMetadata) {
				...
				eventContext.trigger('render-model', {templateName: 'compositeExplorer', model: compositeMetadata, targetSelector: "#inspectorMain"});
		...
		this.get('/composite/new', function () {
			this.redirect('/composite/new/#composite-explorer');
		});
