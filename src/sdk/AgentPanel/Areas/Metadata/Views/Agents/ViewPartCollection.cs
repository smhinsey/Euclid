...
namespace AgentPanel.Areas.Metadata.Views.Agents
{
	...
	[PageVirtualPath("~/Areas/Metadata/Views/Agents/ViewPartCollection.cshtml")]
	public class _Page_Areas_Metadata_Views_Agents_ViewPartCollection_cshtml : WebViewPage<PartCollectionModel>
	{
#line hidden
		...
		public override void Execute()
		{
			...
			foreach (var part in Model.Parts.Collection)
			{
				...
				Write(Url.Action(@Model.NextActionName, "Agents", 
				                 new {agentSystemName = Model.Parts.AgentSystemName, partName = part.Name}));
